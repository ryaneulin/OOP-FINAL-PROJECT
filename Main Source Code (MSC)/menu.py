...
sprite_images = [
    pygame.image.load("my_game\\assets\\0.png").convert_alpha(),
    pygame.image.load("my_game\\assets\\1.png").convert_alpha(),
    pygame.image.load("my_game\\assets\\2.png").convert_alpha(),
    pygame.image.load("my_game\\assets\\3.png").convert_alpha()
]
